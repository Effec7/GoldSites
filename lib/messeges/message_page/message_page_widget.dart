...
class _MessagePageWidgetState extends State<MessagePageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChatInboxRow>>(
      future: ChatInboxTable().queryRows(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatInboxRow> messagePageChatInboxRowList = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('MESSAGE_PAGE_PAGE_Icon_vdjvb582_ON_TAP');
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  if (messagePageChatInboxRowList.length > 0)
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final chatinbox =
                                messagePageChatInboxRowList.toList();

                            return ListView.separated(
                              padding: EdgeInsets.zero,
                              scrollDirection: Axis.vertical,
                              itemCount: chatinbox.length,
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 18.0),
                              itemBuilder: (context, chatinboxIndex) {
                                final chatinboxItem = chatinbox[chatinboxIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 8.0, 16.0, 8.0),
                                  child: Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MESSAGE_PAGE_PAGE_Row_gyrqm4br_ON_TAP');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (chatinboxItem.unreadCount! > 0
                                              ? true
                                              : false)
                                            Padding(
                                              padding: EdgeInsetsDirectional
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Konverzácie s poskytovateľmi sa zobrazia tu.',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
